     ...
     <li class="nav-item">
         ...
         <div id="collapseBootstrapassests" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 <h6 class="collapse-header">Manage Area Supervisors</h6>
                 <a class="collapse-item" href="createClass.php">Create Area </a>
                 <a class="collapse-item" href="createClassTeacher.php">Create Area Supervisors</a>
